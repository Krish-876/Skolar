...
Widget build(BuildContext context) {
  final progress =
      target > 0 ? (earned / target).clamp(0.0, 1.0) : 0.0;
  return SizedBox(
    width: 160,
    height: 160,
    child: CustomPaint(
  ...
  return Padding(
    ...
    child: Container(
      ...
      padding: const EdgeInsets.fromLTRB(
          AppTheme.lg, AppTheme.lg, AppTheme.lg, AppTheme.xl),
      child: Column(
        mainAxisSize: MainAxisSize.min,
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              focusedBorder: const UnderlineInputBorder(
                borderSide:
                    BorderSide(color: AppTheme.onBackground2, width: 2),
              ),
...
final Future<String?> Function(String name, String courseCode, int credits) onConfirm;

const AddSubjectSheet({super.key, required this.onConfirm, this.remainingCredits});
  ...
  return Column(
    ...
    children: [
      ...
      TextField(
        ...
        style: const TextStyle(
            color: AppTheme.onBackground, fontSize: 15),
        cursorColor: AppTheme.onBackground2,
        decoration: InputDecoration(
          hintText: hint,
          hintStyle: TextStyle(
          ...
          focusedBorder: const UnderlineInputBorder(
            borderSide:
                BorderSide(color: AppTheme.onBackground2, width: 1.8),
          ),
