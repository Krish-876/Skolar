...
class AppTheme {
  ...
  static const Color onSurfaceDark    = Color(0xFF000000); // Dark text on light surface
  static const Color onBackground2    = Color(0xFFA8C4FF); // Secondary text / light blue
  static const Color surfaceLight     = Color(0xFF3A3750); // Lighter surface variant
  ...
  static const Color bgGradEnd        = Color(0xFF000005); // Background gradient bottom
  static const Color surfaceGradBegin = Color(0xFF0D1B3E); // Surface gradient top
  static const Color surfaceGradEnd   = Color(0xFF05061A); // Surface gradient bottom
  ...
  static ThemeData get darkTheme => ThemeData(
        ...
        textTheme: TextTheme(
          ...
          labelLarge:    const TextStyle(color: onPrimary, fontWeight: FontWeight.w600),
        ),
        // cardTheme: CardTheme(
        //   color: surface,
        //   elevation: 0,
